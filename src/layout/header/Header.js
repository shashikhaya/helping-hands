                    ...
                    <div className="flex items-center justify-between h-16">
                        <div className=" flex items-center">
                            ...
                            {loggedIn &&
                                <div className="hidden md:block">
                                    <div className="float-right flex items-baseline space-x-4">
                        ...
                        {loggedIn &&
                            <div class="flex md:hidden">
                                <button class="text-gray-800 dark:text-white hover:text-gray-300 inline-flex items-center justify-center p-2 rounded-md focus:outline-none" onClick={toggleDropdown}>
